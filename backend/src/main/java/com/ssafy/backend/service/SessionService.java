...
public interface SessionService {
    ...
    void clearSession();
    Recording recordingStart(String userId, Long sessionIdx, Map<String, Object> params);
    Recording recordingStop(String userId, Long sessionIdx, Map<String, Object> params);
}
